...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_FIRST] = LAYOUT(
        LCTL(KC_S), LCTL(KC_LALT), KC_C,         KC_LALT,
        LCTL(KC_Z), LCTL(KC_Y),    LALT(KC_SPC), KC_SPC,  SECOND
    ),
    [_SECOND] = LAYOUT(
        KC_P,             KC_E,       KC_G,             KC_M,
        LSFT(LCTL(KC_T)), LCTL(KC_U), LSFT(LCTL(KC_N)), LCTL(KC_E), FIRST
    ),
};
